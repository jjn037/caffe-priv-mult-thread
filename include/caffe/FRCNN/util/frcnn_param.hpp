...
public:
  ...
  static float pixel_stds[3];
  static float reid_pixel_means[3]; // BGR_
  static float reid_pixel_stds[3];
  static int rng_seed;
  static float eps;
  static float inf;
  ...
  // ========================================
  static std::string det_proto;
  static std::string det_weight;

  static std::string reid_proto;
  static std::string reid_weight;

  static std::string reid_feature;
  static int gpu_id;

  static float reid_thresh;
