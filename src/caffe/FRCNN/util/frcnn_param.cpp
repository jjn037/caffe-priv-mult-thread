...
float FrcnnParam::pixel_stds[3];
float FrcnnParam::reid_pixel_means[3]; // BGR
float FrcnnParam::reid_pixel_stds[3];
...
// =======================================
std::string FrcnnParam::det_proto;
std::string FrcnnParam::det_weight;
std::string FrcnnParam::reid_proto;
std::string FrcnnParam::reid_weight;
std::string FrcnnParam::reid_feature;
int FrcnnParam::gpu_id;
float FrcnnParam::reid_thresh;
...
void FrcnnParam::load_param(const std::string default_config_path) {
  ...
  std::copy(v_tmp.begin(), v_tmp.end(), FrcnnParam::pixel_means);
    v_tmp = extract_vector("pixel_stds", default_map);
  std::copy(v_tmp.begin(), v_tmp.end(), FrcnnParam::pixel_stds);
  v_tmp = extract_vector("reid_pixel_means", default_map);
  std::copy(v_tmp.begin(), v_tmp.end(), FrcnnParam::reid_pixel_means);
    v_tmp = extract_vector("reid_pixel_stds", default_map);
  std::copy(v_tmp.begin(), v_tmp.end(), FrcnnParam::reid_pixel_stds);
  ...
  //=========================================
  FrcnnParam::det_proto = extract_string("det_proto", default_map);
  FrcnnParam::det_weight = extract_string("det_weight", default_map);
  FrcnnParam::reid_proto = extract_string("reid_proto", default_map);
  FrcnnParam::reid_weight = extract_string("reid_weight", default_map);
  FrcnnParam::reid_feature = extract_string("reid_feature", default_map);
  FrcnnParam::gpu_id = extract_int("gpu_id", default_map);
  FrcnnParam::reid_thresh = extract_float("reid_thresh", default_map);
}
